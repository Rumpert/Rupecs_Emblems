...
public class RealityManipulatorRecipe implements Recipe<SimpleContainer> {
    private final List<IngredientWithNbt> ingredientsWithNbt;
    private final ItemStack output;
    private final ResourceLocation id;
    private final float successChance;

    public RealityManipulatorRecipe(List<IngredientWithNbt> ingredientsWithNbt, ItemStack output, ResourceLocation id, float successChance) {
    ...
    public static class Type implements RecipeType<RealityManipulatorRecipe> {
        public static final Type INSTANCE = new Type();
        public static final String ID = "reality_manipulation";
    }

    public static class Serializer implements RecipeSerializer<RealityManipulatorRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID = new ResourceLocation(Rupecs_Emblems.MOD_ID, "reality_manipulation");

        @Override
        public RealityManipulatorRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
            ItemStack output = ShapedRecipe.itemStackFromJson(GsonHelper.getAsJsonObject(pSerializedRecipe, "output"));
            float successChance = GsonHelper.getAsFloat(pSerializedRecipe, "success_chance", 1.0f);
            ...
            return new RealityManipulatorRecipe(ingredients, output, pRecipeId, successChance);
        }

        @Override
        public @Nullable RealityManipulatorRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
            ...
            float successChance = pBuffer.readFloat();
            return new RealityManipulatorRecipe(ingredients, output, pRecipeId, successChance);
        }

        @Override
        public void toNetwork(FriendlyByteBuf pBuffer, RealityManipulatorRecipe pRecipe) {
            ...
            pBuffer.writeFloat(pRecipe.successChance);
        }
    }
}