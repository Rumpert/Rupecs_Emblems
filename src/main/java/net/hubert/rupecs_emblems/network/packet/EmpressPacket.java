...
public class EmpressPacket {
    public EmpressPacket() {

    }
    public EmpressPacket(FriendlyByteBuf buf) {
    ...
    public boolean handle(Supplier<NetworkEvent.Context> supplier) {
        ...
        context.enqueueWork(() -> {
            ...
            assert player != null;
            player.addEffect(new MobEffectInstance(ModEffects.FARMERS_BLESSING.get(), (int) Math.min(100*player.getAttributeValue(ModAttributes.THE_EMPRESS.get()),300), 9));
