...
public class DamagingNoteRender extends EntityRenderer<DamagingNoteProjectile> {

    private static final ResourceLocation BASE_HEALING_NOTE_TEXTURE = new ResourceLocation(Rupecs_Emblems.MOD_ID, "textures/entity/damaging_note_base.png");
    private static final ResourceLocation HIGH_HEALING_NOTE_TEXTURE = new ResourceLocation(Rupecs_Emblems.MOD_ID, "textures/entity/damaging_note_high.png");
    private static final ResourceLocation SUPER_HEALING_NOTE_TEXTURE = new ResourceLocation(Rupecs_Emblems.MOD_ID, "textures/entity/damaging_note_super.png");

    public DamagingNoteRender(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(DamagingNoteProjectile entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(DamagingNoteProjectile entity) {
        int tier = (int) (entity.getDamageAmount() / 5);
        return switch (tier) {
            case 0 -> BASE_HEALING_NOTE_TEXTURE;
            case 1 -> HIGH_HEALING_NOTE_TEXTURE;
