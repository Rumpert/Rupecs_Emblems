...
public class CometShardRender extends EntityRenderer<CometShardProjectile> {

    private static final ResourceLocation COMET_SHARD_TEXTURE = new ResourceLocation(Rupecs_Emblems.MOD_ID, "textures/entity/comet_shard.png");

    public CometShardRender(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(CometShardProjectile entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(CometShardProjectile entity) {
