...
public class GreenHeartParticle extends TextureSheetParticle {

    protected GreenHeartParticle(ClientLevel world, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public @Nullable Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double v, double v1, double v2,
            ...
            return new GreenHeartParticle(clientLevel, v, v1 ,v2, this.spriteSet, v3, v4, v5);
        }
    }
}
